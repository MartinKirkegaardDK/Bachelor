...
def confidence_plot_lasso_without_dist_all_metrics_without_pca():
    ...
    feature_dict = gen_feature_dict_lasso(s,all_distance= True)
...
def confidence_plot_lasso_with_dist_all_metrics_without_pca():
    pipe = Pipeline([("StandardScaler",StandardScaler()),("Lasso_regressor",LassoCV(max_iter= 10000))])
...
def run():
    print("plotting confidence_plot_lasso_without_dist_all_metrics_without_pca")
    confidence_plot_lasso_without_dist_all_metrics_without_pca()
    print("plotting confidence_plot_lasso_with_dist_all_metrics_without_pca")
    confidence_plot_lasso_with_dist_all_metrics_without_pca()